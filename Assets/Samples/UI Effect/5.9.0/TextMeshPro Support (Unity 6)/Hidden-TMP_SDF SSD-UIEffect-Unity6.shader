// [OptionalShader] com.coffee.softmask-for-ugui: Hidden/TextMeshPro/Distance Field SSD (UIEffect)
// [OptionalShader] com.coffee.ui-effect: Hidden/TextMeshPro/Distance Field SSD (SoftMaskable)
Shader "Hidden/TextMeshPro/Distance Field SSD (UIEffect)" {
...
SubShader {
    ...
    Pass
    {
		...
		#include "Assets/THIRD-PARTY/TextMesh Pro/Shaders/TMPro_Properties.cginc"
		#include "Assets/THIRD-PARTY/TextMesh Pro/Shaders/TMPro.cginc"
		...
		fixed4 uieffect_frag(float2 uv)
		{
            ...
            float pixelSize = abs(ddx(input.atlas.y + uvMove.y)) + abs(ddy(input.atlas.y + uvMove.y));
            ...
            #if UNDERLAY_ON
            float d = tex2D(_MainTex, input.texcoord2.xy + uvMove).a * bScale;
