...
/// <summary>
/// Weapon handler for the shuriken fighting style. Mirrors <see cref="ThrownBombHandler"/>
/// but launches a straight-flying <see cref="ThrownProjectileShuriken"/> instead of an
/// arcing bomb.
/// </summary>
public class ThrownShurikenHandler : MonoBehaviour, IWeaponHandler
{
    private const string DRAW_CLIP_SLOT_KEY = "ReplaceableDrawWeapon";
    private const string DRAW_ANIM_STATE = "ReplaceableDrawWeapon";

    private const float THROW_FORCE = 18f;
    ...
    private void ThrowProjectile()
    {
        ...
        ThrownProjectileShuriken projectile = _weaponInstance.AddComponent<ThrownProjectileShuriken>();
